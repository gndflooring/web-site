...
const HOME_SCHEMA = [
  ...
  { key: 'contact', label: 'Contact & Business Details', fields: [
    { k: 'eyebrow', t: 'text', label: 'Eyebrow', md: true },
    { k: 'heading', t: 'text', label: 'Heading', md: true },
    { k: 'subcopy', t: 'textarea', label: 'Sub-copy', md: true },
    { k: 'phone', t: 'text', label: 'Phone (display) — also used in the footer & SEO', md: true },
    { k: 'phoneHref', t: 'text', label: 'Phone link (tel:+15551234567)' },
    { k: 'email', t: 'text', label: 'Email — also used in the footer & SEO', md: true },
    ...
    { k: 'addressRegion', t: 'text', label: 'State' },
    { k: 'addressPostal', t: 'text', label: 'ZIP' },
    { k: 'addressCountry', t: 'text', label: 'Country code' },
    { k: 'priceRange', t: 'text', label: 'Price range ($, $$, $$$)' },
    { k: 'sameAs', t: 'list', of: 'string', label: 'Profile links — Google Business, Facebook, Instagram' },
  ] },
